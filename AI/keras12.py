...
# 3. Normalise: 0-255 -> 0-1 (faster training, better convergence)
X_train = X_train / 255.0
X_test = X_test / 255.0

# 4. Flatten 28x28 -> 784 (1D vector)
...
# See architecture: layers, shapes, parameters
model.summary()
...
# 10. See predictions on test images
